...
const DesktopView: React.FC<DesktopViewProps> = ({ recipe, checkedItems, onCheck }) => {
  return (
    <div className="hidden md:flex md:flex-row gap-6 w-full">
      <div className="w-1/3 h-full overflow-y-auto scrollable-container px-4 xs:py-4 border-r border-gray-200 dark:border-gray-700">
      ...
      <div className="w-2/3 h-full overflow-y-auto scrollable-container px-4 xs:py-4">
        <h2 className="text-2xl font-semibold text-leaf-green-900 dark:text-leaf-green-100 mb-4">
          Directions
        </h2>
